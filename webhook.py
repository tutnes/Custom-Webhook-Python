...
PYTHON_NOTIFICATION = config['python_notification']['active'];
...
def call_integration(problem_id):
    ...
    if PYTHON_NOTIFICATION:
        call_python_integration(problem_details)
...
def call_python_integration(problem_details):
    python_integration.python_integration(problem_details)
    return
